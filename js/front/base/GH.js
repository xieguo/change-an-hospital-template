...
function(e, t) {
    var i = {
        modules: {
            autocomplete: [$GC.jsCPath + "/plugins/jquery.ui.core.js", $GC.jsCPath + "/plugins/jquery.ui.autocomplete.js?_=" + $GC.version],
            select2: $GC.jsCPath + "/plugins/select2.js?_=" + $GC.version,
            focusSlider: $GC.jsCPath + "/plugins/jquery.focus.slider.js?_=" + $GC.version,
            fastMenu: $GC.jsCPath + "/plugins/jquery.menu.js",
            bxslider: $GC.jsCPath + "/plugins/jquery.bxslider.js",
            citypicker: $GC.jsCPath + "/plugins/gl-citypicker.js",
            areapicker: $GC.jsCPath + "/plugins/jquery-gl-areapicker.js?_=" + $GC.version,
            crypt: $GC.jsCPath + "/plugins/jquery.crypt.js",
            RSACrypt: $GC.jsCPath + "/plugins/rsa.crypt.js",
            datepicker: [$GC.jsCPath + "/plugins/jquery.ui.core.js", $GC.jsCPath + "/plugins/jquery.ui.datepicker.js"],
            jcrop: $GC.jsCPath + "/plugins/jquery.Jcrop.js",
            pagination: $GC.jsCPath + "/plugins/jquery-gl-pagination.js",
            schedule: $GC.jsCPath + "/plugins/jquery-gl-schedule.js?_=" + $GC.version,
            "schedule-temp": $GC.jsCPath + "/plugins/jquery-gl-schedule-temp.js?_=" + $GC.version,
            swfupload: $GC.jsCPath + "/plugins/swfupload.js?_=" + $GC.version,
            iframeUpload: $GC.jsCPath + "/plugins/jquery.iframe.upload.js?_=" + $GC.version,
            tooltip: $GC.jsCPath + "/plugins/tooltip.js",
            datehelper: $GC.jsCPath + "/plugins/datehelper.js",
            validator: $GC.jsCPath + "/plugins/validator.js?_=20160129",
            highlight: $GC.jsCPath + "/plugins/jquery.highlight.js",
            json2: $GC.jsCPath + "/plugins/json2.js",
            cookie: $GC.jsCPath + "/plugins/jquery.cookie.js",
            jqeasing: $GC.jsCPath + "/plugins/jquery.easing.js",
            aTpl: $GC.jsCPath + "/plugins/aTpl.js",
            socket: $GC.jsCPath + "/plugins/socket.io.js?_=" + $GC.version,
            chart: $GC.jsCPath + "/plugins/chart.js?_=" + $GC.version,
            xssfix: $GC.jsCPath + "/plugins/xssfix.js",
            jqtmpl: $GC.jsCPath + "/plugins/jquery.tmpl.js",
            placeholder: $GC.jsCPath + "/plugins/jquery.placeholder.js",
            wowjs: $GC.jsCPath + "/plugins/wow.js",
            poshytip: $GC.jsCPath + "/plugins/jquery.poshytip.js",
            nicescroll: $GC.jsCPath + "/plugins/jquery.nicescroll.min.js",
            modal: $GC.jsCPath + "/plugins/jquery-gl-modal.js?_=" + $GC.version,
            collapse: [$GC.jsCPath + "/plugins/jquery.collapse.js", $GC.jsCPath + "/plugins/jquery.collapse_storage.js", $GC.jsCPath + "/plugins/jquery.collapse_cookie_storage.js"],
            aes: [$GC.jsCPath + "/plugins/aes.js", $GC.jsCPath + "/plugins/crypto.js"],
            area: $GC.jsCPath + "/plugins/area.js",
            dialog: $GC.jsCPath + "/plugins/dialog.js",
            uploadThumbnail: $GC.staticServer + "/front/portal-pc-static/" + ($GC.debug ? "jsdev" : "js") + "/plugins/upload-thumbnail.js?_=" + $GC.version,
            ueditor: $GC.staticServer + "/lib/ueditor/" + ($GC.debug ? "ueditor.all.js" : "ueditor.all.min.js") + "?_=" + $GC.version,
            photoview: $GC.jsCPath + "/plugins/photoView.js?_=" + $GC.version,
            PGC: $GC.jsCPath + "/plugins/PassGuardCtrl.js?_=" + $GC.version,
            "crypto-js": $GC.jsCPath + "/plugins/crypto-js.js",
            pgwModal: $GC.jsCPath + "/plugins/pgwmodal.js",
            lazyLoad: $GC.staticServer + "/front/portal-pc-static/" + ($GC.debug ? "jsdev" : "js") + "/plugins/jquery.lazyload.js?_=" + $GC.version,
            qrGenerator: $GC.jsCPath + "/plugins/qrcode.js?_=" + $GC.version,
            "art-template": $GC.staticServer + "/front/portal-pc-static/" + ($GC.debug ? "jsdev" : "js") + "/plugins/template-web.js?_=" + $GC.version,
            jqueryForm: $GC.staticServer + "/front/portal-pc-static/" + ($GC.debug ? "jsdev" : "js") + "/plugins/jquery.form.js?_=" + $GC.version
        },
        ...
        H5ApiRequest: {
            defaults: {
                ...
                error: function() {},
                complete: function() {},
                preUrl: $GC.gatewayServer + "/healthaccount",
                headers: {
                    "weiyi-authtoken": e(".J_UserToken").val(),
                    "weiyi-appid": e(".J_UserAppId").val() || "p_web_weiyi",
                    Accept: "*/*"
                }
            },
            ajax: function(t) {
                var i = e.extend({}, this.defaults, t);
                if (i.url && i.url.indexOf("http") === -1 && (i.url = i.preUrl + i.url),
                i.data && "string" != typeof i.data)
                    try {
                        i.data = JSON.stringify(i.data)
                    } catch (n) {
                        return void $GM.smartAlert("请求JSON解析错误")
                    }
                i.token && (i.headers.authtoken = i.token),
                e.ajax({
                    url: i.url,
                    headers: i.headers,
                    type: i.type,
                    ...
                    success: function(e) {
                        if ("string" == typeof e)
                            try {
                                ...
                                return void $GM.smartAlert("返回JSON解析错误")
                            }
                        i.success ? 0 == e.code && i.success(e) : $GM.smartAlert(e.message || " 请求成功！")
                    },
                    error: function(e, t) {
                        if ("string" == typeof e)
                            try {
                        ...
                        i.error ? i.error(e, t) : $GM.smartAlert(e.message || " 请求失败！")
                    },
                    complete: function() {
...
GreenLine.Util = {
    ...
    animate: function(e, t) {
        if ("transform"in document.documentElement.style || "MozTransform"in document.documentElement.style || "WebkitTransform"in document.documentElement.style || "OTransform"in document.documentElement.style || "msTransform"in document.documentElement.style) {
            ...
            e.each(function() {
                ...
                t && ($("html").css("overflow-x", "hidden"),
                $(this).show().addClass(t).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                    $(this).removeClass(t),
    ...
    iwant: {
        ...
        _adRender: function(e, t, i) {
            var n = this;
            t.img && "" != t.img && (t.code = n._adCode[e.data("pos")],
            t.link && "" != t.link ? (t.index = i,
            e.append($GU.compileTmpl(n._adLinkTmpl, t))) : e.append($GU.compileTmpl(n._adTmpl, t)))
        },
        _adTopRender: function(e) {
            ...
            if (e.length > 0) {
                ...
                if (e.img && "" != e.img) {
                    ...
                    $("<i/>").appendTo(i).on("click", function() {
                        return i.slideUp(),
        ...
        ads: function(e) {
            ...
            if (0 !== $(".J_Promotions").length || t) {
                var i = this
                  , n = "/iwant/promotion?q=" + (e.attr("content") || "")
                  , o = [];
                ...
                a.forEach(function(e) {
                    $.ajax({
                        ...
                        cache: !1,
                        success: function(e) {
                            if (!e || e.hasError || !e.data)
                                return $(".J_Promotions").remove(),
                                !1;
                            var n = e.data;
                            $(".J_Promotions").each(function(e, t) {
                                var o = $(t)
        ...
        _expertRender: function(e, t) {
            null != e.data("type") && "consult" == e.data("type") && (1 != t.isImageText && (t.img = "hide"),
            1 != t.isPhone && (t.tel = "hide"),
            1 != t.isVideo && (t.video = "hide"),
            t.totalCount = "" + t.totalConsultCount),
            t.departmentUuid = "",
    ...
    upload: {
        ...
        uploadInit: function(e) {
            var t = this;
            e = e || 6,
            $(".J_CertUpload").on("click", function() {
                return !$(this).hasClass("uploading") && (t.certImgs.length === e ? ($GM.smartAlert("抱歉，最多只能上传" + e + "张图片。"),
                $(".J_CertUpload").val(""),
                !1) : void 0)
            }),
            $("body").on("click", ".J_RemoveImg", function() {
                for (var e = $(this).data("url"), i = 0; i < t.certImgs.length; i++)
                    if (e === t.certImgs[i]) {
        ...
        uploadCore: function() {
            ...
            $(".J_CertUpload").ajaxfileupload({
                ...
                onComplete: function(t) {
                    if ($(".J_UploadText").text("上传图片资料"),
                    $(".J_CertUpload").removeClass("uploading"),
                    t && t.status === !1)
                        return $GM.smartAlert(t.message),
                    ...
                    return !t || t.hasError ? ($GM.smartAlert(t && t.message || "抱歉，上传失败。"),
                    void $(".J_CertUpload").val("")) : (e.certImgs.push(t.data),
                    e.previewImg(t.data),
                    $.browser.msie ? ($(".J_CertUpload").replaceWith('<input type="file" name="certificate1" class="upload-input J_CertUpload">'),
                    e.iframeUpload()) : $(".J_CertUpload").val(""),
                    $("#J_HiddenCertImgs").val(e.certImgs.join(",")),
                    void $(".certificate1ErrorMsg").hide())
                }
            })
        },
    ...
    parse15Id: function(e) {
        var t, i = new RegExp(/^(\d{6})(\d{2})(\d{2})(\d{2})(\d{3})$/), n = e.match(i), o = "19" + n[2] + "-" + n[3] + "-" + n[4];
        return t = e.substr(14, 1) % 2 == 0 ? 2 : 1,
        new Array(o,t)
    },
    parse18Id: function(e) {
        var t, i = new RegExp(/^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X|x)$/), n = e.match(i), o = n[2] + "-" + n[3] + "-" + n[4];
        return t = e.substr(16, 1) % 2 == 0 ? 2 : 1,
        new Array(o,t)
    },
    verifyIdcard: function(e, t) {
        var i = {
            y: "1900",
            m: "01",
            d: "01",
          ...
          , n = function(t) {
            i.length = t;
            var n, o = 15 === t ? 0 : 2;
            return i.y = (o ? "" : "19") + e.substring(6, 8 + o),
            i.m = e.substring(8 + o, 10 + o),
            i.d = e.substring(10 + o, 12 + o),
            i.sex = e.substring(14, 15 + o) % 2 === 0 ? "female" : "male",
            n = new Date(i.y,i.m - 1,i.d),
            n.getFullYear() == 1 * i.y && n.getMonth() + 1 == 1 * i.m && n.getDate() == 1 * i.d
        }
          , o = function() {
            return t ? i : i.valid
        };
        if ("string" != typeof e)
            return o();
        if (/^\d{17}[0-9x]$/i.test(e)) {
            if (!n(18))
                return o();
            e = e.toLowerCase().split("");
            for (var a = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2], s = "10x98765432".split(""), r = 0, l = 0; l < 17; l++)
                r += a[l] * e[l];
            return s[r % 11] === e.pop().toLowerCase() && (i.valid = !0),
            o()
        }
        return /^\d{15}$/.test(e) ? (n(15) && (i.valid = !0),
        o()) : o()
    },
    getAge: function(e) {
    ...
    request: function() {
        ...
        return function(t) {
            ...
            var o = {
                ...
                dataType: "json",
                success: function(e) {
                    e && 1 != e.hasError ? a && a.call(null, e) : ($GM.smartAlert(e && e.message || "操作失败"),
                    s && s.call(null, e, !0))
                },
                error: function(e) {
    ...
    splitPage: function(e, t, i) {
        !i && (i = 5);
        for (var n = Math.min(Math.max(e, Math.ceil(i / 2)) + Math.floor(i / 2), t), o = Math.max(n - i + 1, 1), a = {}, s = o; s < n + 1; a[s] = s == e,
        s++)
            ;
        return a
    },
    getTime: function(e, t) {
        ...
        for (var o in n)
            n[o.toUpperCase()] = (n[o] < 10 ? "0" : "") + n[o];
        if (n.w = i.getDay(),
        n.W = "日一二三四五六".substr(n.w, 1),
        n.timestamp = i.getTime(),
        n.date = i,
        "string" == typeof e) {
            for (var o in n)
                e = e.replace(new RegExp("(" + o + ")","g"), function(e, t) {
                    return n[t]
                });
            return e
        }
        ...
        function i(e, i, n) {
            ...
            var o = 60
              , a = setInterval(function() {
                --o <= 0 ? ($GUB.enable(e, t.text2 || "重发"),
                i && i.hide(),
                n && n.hide(),
                clearInterval(a)) : $GUB.setText(e, o + t.text3 || o + "秒后重发")
            }, 1e3);
            return a
        }
        return GL.load([GH.modules.crypt, GH.modules.aes], function() {
            if ($GUB.isActive(e)) {
                $GUB.disable(e, "发送中...");
                ...
                }) : "RES" == s ? (c += "/validcode/json/ordermobilevalidcode",
                d = {
                ...
                }) : "RES_VOICE" == s ? (c += "/validcode/json/focusordermobilevalidcode",
                d = {
                    type: "RES_CODE_MOBILE",
                    pid: o,
                    hde: t.hde,
                ...
                }) : "REG_MOBILE" == s ? (t.param && $.extend(d, t.param),
                c += "/validcode/json/sendcode/oauth/1/" + d.mobile_token) : "PWD_RESET_MOBILE" == s ? c += "/validcode/json/mobile/" + encodeURIComponent(n) + "/" + encodeURIComponent(a) + "/PWD_RESET_MOBILE/" + $().crypt({
                    method: "md5",
                ...
                }) : "JKBD" == s ? (c += "/partners/jkbd/jkbdCheck",
                d = {
                    type: s,
                    mobile: n,
    ...
    showTips: function(e) {
        var t, i = $(e.container), n = e.content;
    ...
    checkLogin: function() {
        return !!$GC.isLogined || (top.$("#gh .login").trigger("click"),
        !1)
    },
    geeTestCaptcha: {
        init: function(e) {
            ...
            var i = function() {
                $.ajax({
                    url: $GC.guahaoServer + "/gee/test/code/pre/process?businessType=" + t.opt.businessType,
                    type: "get",
                    dataType: "JSON",
                    cache: !1,
                    success: function(e) {
                        e && !e.hasError && e.data && (e = JSON.parse(e.data),
                        e && 1 == e.success ? t.loadGeetest(e, t.opt) : $GU.monitor.info("ua:" + navigator.userAgent, "JYERROR_02"))
                    },
                    error: function() {
        ...
        loadGeetest: function(e, t) {
            ...
            initGeetest({
                ...
                i.captchaObj = e,
                "bind" !== t.product && e.appendTo(".J_GeeTestMain"),
                e.onReady(function() {
                    $(".J_GeeTestMain").text("")
                }).onSuccess(function() {
                    var t = e.getValidate()
                    ...
                    $.ajax({
                        url: $GC.guahaoServer + "/gee/test/code/enhance/validate",
                        type: "post",
                        data: n,
                        dataType: "JSON",
                        cache: !1,
                        success: function(t) {
                            t && !t.hasError && t.data ? ($("#J_GeeTestValid").val("1"),
                            $("#validCode").val(t.data),
                            "bind" === i.opt.product && i.opt.testSucc()) : ($GM.smartAlert("二次校验失败，请重新点击按钮进行验证"),
                            e.reset())
                        },
                        error: function() {
                            $GM.smartAlert("二次校验失败，请重新点击按钮进行验证"),
                            e.reset()
                        }
                    })
                }).onError(function() {
        ...
        initModal: function() {
            var e = this;
            $(".J_GeeTest").length > 0 || "bind" === e.opt.product || $(e.opt.context).append('<div class="J_GeeTest"><div class="J_GeeTestMain" monitor="userlogin,register,slide_verify">正在初始化验证码...</div> </div>')
        }
    },
...
function(e) {
    ...
    e.fn.glPlaceholder = function(i) {
        ...
        if (!t.support()) {
            ...
            "gm-login" == i ? (s.css("width", "200px"),
            s.css("position", "relative").css("height", "30px").css("display", "inline-block")) : (s.css("width", o.get(0).offsetWidth + 8),
            s.css("position", "relative").css("height", o.get(0).offsetHeight).css("display", "inline-block")),
    ...
    e.fn.countdown = function(t, i, n) {
        if (this.length) {
            ...
            var o = e(this[0]).html(n.replace(/time/g, i))
              , a = setInterval(function() {
                --i ? o.html(n.replace(/time/g, i)) : (clearInterval(a),
                t.call(o))
            }, 1e3)
        }
    }
...
GreenLine.Modal2 = {
    ...
    smartModal: function(e, t) {
        ...
        0 == n.length ? n = $("<div/>", {
            "class": "gm-box",
            id: t.id
        }).append($('<div class="title"><span>' + t.title + "</span>" + (t.showClose ? '<a href="javascript:;" class="close gm-close"></a>' : "") + "</div>"), $('<div class="body"><p>' + t.message + "</p></div>"), $('<div class="action"><a href="javascript:;" class="gbn gbt-blue1 gm-action" id="js-confirm-bt">' + t.btnText + "</a></div>")).appendTo($("#gm-mask")) : (n.find(".title").find("span").text(t.title),
        n.find(".action").find("#js-confirm-bt").text(t.btnText),
        n.find(".body p").html(t.message)),
        n.find(".gm-close").on("click", function() {
            return "function" == typeof t.close && t.close(),
            $("#gm-mask .gm-box").hide(),
            $("#gm-bg").hide(),
            !1
        }),
        n.find(".gm-action").on("click", function() {
    ...
    confirm: {
        _init: function(e, t) {
            ...
            e.on("click", ".confirm-btn", function() {
        ...
        _init: function(e, t) {
            ...
            e.on("click", ".confirm-btn", function() {
                ...
                $.ajax({
                    url: t.confirm.url,
                    success: function(o) {
                        if ($('[name="csrf_token"]').val(o.data && o.data.csrf_token ? o.data.csrf_token : ""),
                        ...
                        o.hasError)
                            ...
                            t.callbackOk && i.find("a").on("click", function() {
            ...
            e.on("click", ".js-confirm-close", function() {
    ...
    confirmTreatModal: {
        ...
        checkLogin: function() {
            return !!$GC.isLogined || ($("#gh .login").trigger("click"),
            !1)
        },
        load: function(e, t) {
            function i(i) {
                var o, a = e.attr("href");
                if (i && (n.notConfirmNum = i.map.notTreat),
                o = n.notConfirmNum,
                i && i.hasError || !(o > 0))
                    location.href = a;
                else {
    ...
    init: function() {
        ...
        $("#gm-mask").on("click", ".gm-close", function(t) {
            return e.closeModal($(this)),
            !1
        }),
        $("#gm-mask").on("click", ".gm-b", function(t) {
            return e.closeModal($(this)),
            e.loadModal($(this)),
            !1
        }),
        $("#gm-mask").on("click", ".gm-fb", function(t) {
            return e.closeModal($(this)),
            e.loadModal($(this), !0),
            !1
        }),
        $("body").on("click", ".gm-t", function(t) {
            return e.loadModal($(this)),
            !1
        }),
        $("body").on("click", ".gm-ft", function(t) {
...
GreenLine.Flyout = {
    ...
    init: function() {
        ...
        GreenLine.Flyout.medicalConsult.load(),
        GreenLine.Flyout.ghApp.load(),
        GreenLine.Flyout.weixin.load(),
        GreenLine.Flyout.sina.load(),
        GreenLine.Flyout.helpqs.load(),
        GreenLine.Flyout.ghCorrect.load(),
        GreenLine.Flyout.totop.load(),
        $("#gfo-wrap").length > 0 && (GreenLine.Flyout.fixedEvents($("#gfo-wrap")),
    ...
    mobile: {
        ...
        load: function() {
            ...
            var t = $("<div/>", {
              ...
              , i = this.check()
              , n = "<div class='cw'><a href='" + $GC.guahaoServer + "/userapp'></a><span class='code'><img  src='" + $GC.staticServer + "/front/portal-pc-static/upload/qrlogo/qrApp4.jpg' onerror='this.src=\"" + $GC.guahaoServer + '/qrcode/gener?qrIndex=qrApp4";this.removeAttribute("onerror");\'/></span></div>';
    ...
    wyapp: {
        ...
        handleCommonPopup: function(e, t, i) {
            ...
            if (o !== e && (localStorage.removeItem("_WY_Home_CommonPopup_LastDay"),
            localStorage.removeItem("_WY_Home_CommonPopup_PopupCount"),
            localStorage.removeItem("_WY_Home_CommonPopup_PopupNumber"),
            localStorage.setItem("_WY_Home_CommonPopup_Tag", e)),
            t > 0 && i > 0) {
                ...
                if ((s < t || Number(s) === Number(t) && n(a)) && r < i) {
                    if (n(a)) {
                        ...
                        if ((new Date).getTime() - l < 18e5)
                            return !1
                    } else
                        localStorage.setItem("_WY_Home_CommonPopup_PopupCount", ++s),
                ...
                var a = localStorage.getItem("_WY_Home_CommonPopup_LastDay");
                if (!n(a))
                    return localStorage.setItem("_WY_Home_CommonPopup_LastDay", [(new Date).getFullYear(), (new Date).getMonth() + 1, (new Date).getDate()].join("-")),
                    !0
            }
            return !1
        },
                ...
                $.ajax({
                    ...
                    success: function(e) {
                        if (e && e.data) {
                            ...
                            check && (i.append($("<div class='color-bg'></div><div class='g-container'><div class='cw'><a href='" + n.url + "' target='_blank' onmousedown='return _smartlog(this,\"SYTC\")' monitor='home,bottom,pop' monitor-activity-id='" + n.resourceId + "' monitor-activity-url='" + n.url + "'></a></div><a class='close' href='javascript:;' monitor='home,bottom,pop_close' monitor-activity-id='" + n.resourceId + "' monitor-activity-url='" + n.url + "'></a></div>")).appendTo($("body")),
                            i.find(".cw").css("background-image", "url(" + n.imgUrl + ")")),
    ...
    fixedEvents: function(e) {
        $(window).scroll(function() {
            ...
            if (!(Math.abs(a) > 0)) {
                var s = o + n;
                "gfo-wrap" == e.attr("id") ? (e.find($("#gfo-totop")).length > 0 && $(document).height() - $(window).height() > 300 && ($(document).scrollTop() > 300 ? $("#gfo-totop").fadeIn() : $("#gfo-totop").fadeOut()),
                o + 249 >= t - 60 - i ? e.css({
                    top: t - 60 - i,
                    position: "absolute"
                }) : $GU.isIE6() ? e.css({
    ...
    weixin: {
        ...
        load: function() {
            ...
            var e = $("<div/>", {
                id: "gfo-weixin",
                "class": "item-box"
            }).append($("<span class='weixin-icon'/></span>"), $("<span class='code-box hide'/>").append("<a href='javascript:;' class='bottom'><em>微信公众号</em><img class='icon' src='" + $GC.staticServer + "/images/office-account-qrcode-3.png' /></a>")).appendTo($("#gfo-wrap"));
            e.hover(function() {
    ...
    helpqs: {
        ...
        load: function() {
            if (this.check()) {
                ...
                t.length > 0 && (e.find(".helpqs-box h5").after(t),
                e.show()),
                e.hover(function() {
    ...
    ghApp: {
        ...
        load: function() {
            ...
            var e = $("<div/>", {
                id: "gfo-ghApp",
                "class": "item-box"
            }).append($("<a href='" + $GC.guahaoServer + "/intro/userapp' target='_blank' class='tel-box'/>"), $("<span  class='code-box hide'/>").append("<a href='javascript:;' class='bottom'><em>微信公众号</em><img class='icon' src='" + $GC.staticServer + "/images/office-account-qrcode-2.png'></a>")).appendTo($("#gfo-wrap"));
            e.hover(function() {
    ...
    ghAskfor: {
        ...
        load: function() {
            if (this.check()) {
                ...
                $("<a target='_bank' href='链接商务通1' class='js-correct-dialog item-box' id='ask-for'></a><br/>").appendTo($("#gfo-wrap-other"))
            }
        }
    },
    zsghAskfor: {
        ...
        load: function() {
            if (this.check()) {
                ...
                $("<a target='_bank' href='链接商务通2' class='js-correct-dialog item-box' id='ask-for'></a><br/>").appendTo($("#gfo-wrap-other"))
            }
        }
    },
    ghRegister: {
        ...
        load: function() {
            if (this.check()) {
                ...
                e.click(function() {
                    ...
                    $(".gm-correct-dialog").length > 0 && ($(".gm-correct-dialog").glNewPlaceholder(),
                    $(".gm-correct-dialog").find(".js-correctEmail").keyup(function(e) {
                    ...
                    $GD.init({
                        ...
                        okCall: function() {
                            ...
                            if ($GUB.isActive(e)) {
                                ...
                                i.data("validator").checkValidity() && ($GUB.disable(e, "提交中…"),
                                $.ajax({
                                    ...
                                    success: function(t) {
                                        $GUB.enable(e, "确定"),
                                        t.errors ? $GD.showError(t.errors[0].defaultMessage) : ($(".gm-correct-dialog").find("form").hide(),
                                        $(".gm-correct-dialog").find(".foot").hide(),
                                        $(".gm-correct-dialog").find(".success").show(),
                                        setTimeout(function() {
    ...
    medicalConsult: {
        ...
        load: function() {
            if (this.check()) {
                ...
                e.click(function() {
                    var e = ($(this),
                    $("[data-fo-medicalConsult]").attr("data-fo-medicalConsult"));
                    $GD.init({
                        title: "友情提示",
...
GreenLine.featureLead = {
    init: function(e) {
        ...
        $(e.binddom).length && !$.cookie(e.fedomId)) {
            var t = this;
            t.initDom(e),
            $(window).resize(function() {
                t.getPosition(e)
    ...
    initDom: function(e) {
        ...
        $("#" + e.fedomId).html(e.fedomContent),
        $(e.binddom).clone().addClass("cloneMask").insertBefore("#" + e.fedomId + " .fe-mask-bg")),
        $(".g-feature-bg").show()
    },
...
GreenLine.Widget = {
    fastOrder: {
        ...
        _updateSelect: function(e) {
            ...
            $.ajax({
                ...
                data: i,
                success: function(i) {
                    "dept" == e ? t._addDeptOptions(n, i) : t._addOptions(n, i, e),
        ...
        _addOptions: function(e, t, i) {
            var n = "";
            if ("province" === i && $("input[name='jklj']").length > 0 && "1" === $("input[name='jklj']").val())
                for (var o = 0; o < t.length; o++)
                    if (t[o].text && "黑龙江" == t[o].text) {
                        var a = t[o];
                        n = a.value,
                        t.splice(0, t.length),
                        t.push(a)
            ...
            for (var s = "", o = 0; o < t.length; o++)
                s += '<option value="' + t[o].value + '">' + t[o].text + "</option>";
            "province" === i && $("input[name='jklj']").length > 0 && "1" === $("input[name='jklj']").val() ? (e.append(s).attr("disabled", "disabled").addClass("disabled"),
            e.find("option[value=" + n + "]").prop("selected", !0)) : e.append(s).removeAttr("disabled", "disabled").removeClass("disabled")
        },
        _addDeptOptions: function(e, t) {
            for (var i = "", n = t.hospDepts, o = 0; o < n.length; o++) {
                ...
                for (var r = 0; r < s.length; r++)
                    i += '<option value="' + s[r].value + '">' + s[r].text + "</option>";
                i += "</optgroup>"
            }
    ...
    Location: {
        ...
        initSelcet: function(e, t, i) {
            ...
            s.change(function(t, i) {
                var l = []
                  , c = s.val();
                n.getData(a, c, function(t) {
                    if (0 == t.length)
                        r.hide().attr("disabled", "disabled");
                    else {
                        r.show().removeAttr("disabled");
                        for (var a = 0; a < t.length; a++)
                            l = l.concat(['<option value="', t[a].id, '">', t[a].name, "</option>"]);
                        r.html(l.join("")),
                        i && o(r, i);
                        var s = e.find(".js-location-area");
                        s.length > 0 && (s.data("inited") || (s.data("inited", !0),
                        n.initSelcet(e, ".js-location-city", ".js-location-area", "/area/listarea/")),
                        r.attr("class").indexOf("js-location-city") > -1 && r.trigger("change", s.attr("val")))
                    }
                })
            });
            var l = s.attr("val") || "1";
    ...
    medal: function(e, t) {
        ...
        e && 1 === e.nodeType && !isNaN(t) && 0 !== t) {
            e.innerHTML = "";
            for (var n = function() {
                var e = t;
                return e = Math.max(Math.min(e, 9999), 0).toString(),
                e = ("0000" + e).substr(e.length, 4)
            }(), o = ["gold", "silver", "copper", "flag"], a = ["1000份保险", "100份保险", "10份保险", "1份保险"], s = e.clientWidth || e.offsetWidth - e.clientLeft, r = 33, l = s / r, c = 0, d = 0; d < n.length; d++)
                i(d, n.substr(d, 1))
        }
    },
    upload: function(_option, _config) {
        ...
        var swf, queue = {}, stack = {}, action = {
            ...
            clear: function() {
                var e;
                for (e in queue)
                    queue.hasOwnProperty(e) && this.remove(e)
            },
            remove: function(e) {
                queue[e].remove(),
                delete queue[e],
            ...
            return e.prototype = {
                ...
                set: function(e) {
                    if (e)
                        return void 0 !== e.text && (this.text.innerHTML = this.text.title = e.text),
    ...
    uploadThumbnail: function(e) {
        ...
        t.rel = "stylesheet",
        t.href = $GC.staticServer + "/front/portal-pc-static/css/upload-thumbnail.css?_=" + $GC.version,
        document.head.appendChild(t),
        GL.load([GH.modules.swfupload, GH.modules.uploadThumbnail], function() {
    ...
    expertHospitalCommon2015: function() {
        ...
        Set.prototype = {
            add: function(e) {
                for (var t = this.entries.length; t >= 0; t--)
                    if (e === this.entries[t])
                        return this;
        ...
        var e = {
            ...
            login: function(e) {
                return $GC.isLogined ? (e && e(),
                !0) : document.domain.indexOf("jklj") > -1 ? void (window.location.href = $GC.jkljServer + "/login?returnurl=" + encodeURIComponent(window.location.href)) : ($("#gh .login").click(),
                !1)
            },
            notice: function(e, t) {
            ...
            share: function() {
                ...
                if (e.length) {
                    var t;
                    return e.on("mouseleave mouseenter", function(i) {
            ...
            Slide: function() {
                ...
                return e.prototype = {
                    $bind: function() {
                        ...
                        e.state)
                          , i = e.elem;
                        i.next.length && i.next.on("click", function() {
                            var i = t.page + 1;
                            e.aim(i)
                        }),
                        i.prev.length && i.prev.on("click", function() {
                            var i = t.page - 1;
                            e.aim(i)
                        })
                    },
                    ...
                    aim: function(e) {
                        var t = this
                          ...
                          , n = t.state;
                        t.elem;
                        return 0 !== n.length && (e < 0 && (e = 0),
                        e > n.pageLength - 1 && (e = n.pageLength - 1),
                        n.page = e,
                        n.index = n.page * i.num,
                        void t.$render())
                    },
                    refresh: function() {
                        var e = this
            ...
            Slide2: function() {
                var e = function(e, t) {
                    return !!e.nodeType && (this.wrap = e,
                    this.box = e.children[0],
                    this.container = this.box.children[0],
                ...
                return e.prototype = {
                    ...
                    slide: function(e, t) {
                        var i, n = this.options, o = this.config, t = n.step, a = this.container, s = this.children, r = o.index;
                        if ("prev" === e)
                            i = Math.max(0, r - t);
                        else {
                            var l = o.length;
                    ...
                    toggle: function(e, t, i) {
                        var n = e.nodeType ? e.className : e
                          , o = t.split(" ");
                        if ("string" == typeof n) {
                            for (var a, s, r = 0; a = o[r]; r++)
                                s = i,
                                n = n.replace(/\s+/g, "  ").replace(new RegExp("(^| )" + a + "($| )","gi"), function(e, t, i) {
                                    return void 0 == s && (s = !1),
                                    t + i
                                }),
                                0 != s && (n += " " + a);
        ...
        return $("body").delegate("[data-description]", "click", function() {
    ...
    var e = {
        ...
        addFav: function(e) {
            ...
            if (t.checkLogin(e.element)) {
                var i, n = $(e.element), o = e.type || n.attr("data-type"), a = n.attr("data-id"), s = n.attr("data-name"), r = e.succCall || t.addSuccCall, l = e.errCall || t.addErrCall;
                if (n.html("关注中..."),
                "hosp" === o)
                    i = {
                        furi: "hospital/" + a,
...
function() {
    ...
    GreenLine.Dialog = {
        init: function(t) {
            ...
            i.initListener(),
            n && (i.container.find(".action").hide(),
            i.request(t)),
            i.inited = !0,
            i
        },
        initHtml: function() {
            ...
            return i.noAction || (a.push('<div class="action">'),
            i.noOkBtn || a.push('<a class="', i.okCls || "gbn gbt-blue1", ' js-ok" href="javascript:;">', i.okTxt || "确定", "</a>"),
            i.noCancelBtn || a.push('<a class="', i.cancelCls || "gbn gbt-gray", ' js-cancel" href="javascript:;">', i.cancelTxt || "取消", "</a>"),
            a.push("</div>")),
        ...
        initListener: function() {
            var e = this
              , t = e.container
              , i = e.settings;
            t.delegate(".js-close", "click", function(t) {
                var n = i.closeCall;
                (n && n()) !== !1 && e.hide()
            }),
            i.noAction || (i.noOkBtn || t.delegate(".js-ok", "click", function(t) {
                var n = i.okCall;
                e.hideError(),
                (n && n()) !== !1 && e.hide()
            }),
            i.noCancelBtn || t.delegate(".js-cancel", "click", function(t) {
                var n = i.cancelCall;
                (n && n()) !== !1 && e.hide()
            })),
...
function() {
    GreenLine.openComment = {
        init: function(e) {
            var t = this;
            return $GC.isLogined ? (t.isactive = !0,
            void $GD.load({
                title: e.title,
                width: e.width,
                url: e.target,
        ...
        initFun: function() {
            ...
            t.find("form").length > 0) {
                ...
                GL.load([GH.modules.datepicker], function() {
        ...
        checkTextArea: function(e) {
            function t(e) {
                for (var t = e.length, i = 0, n = 0; n < t; n++)
                    e.charCodeAt(n) < 27 || e.charCodeAt(n) > 126 ? i += 2 : i++;
                return i
            }
            var i = (new RegExp(/^[A-Za-z\u4e00-\u9fa5]+$/),
            e.find("textarea").val())
              , n = t(i);
            return n > 500 || n < 5 ? (this.showErrInfo("您输入的文字长度未符合要求."),
            null) : "ok"
        },
        doRequest: function(e) {
            var t = e.attr("action")
              , i = this;
            e.data("validator").checkValidity() && i.isactive && (i.isactive = !1,
            e.find(".js-ok").html("提交中..."),
            $.ajax({
                url: t,
                cache: !1,
                data: e.serialize(),
                ...
                dataType: "json",
                success: function(e) {
                    e.hasError ? i.showErrInfo(e) : (i.cont.find(".body").html("<div class='request-result'><div class='gi1 gi-bigger-succ'></div><div class='title-text'>感谢您的评价！</div></div>"),
                    i.cont.find(".js-ok").remove(),
                    i.cont.find(".js-cancel").removeClass("gbt-gray").addClass("gbt-green").html("关闭"))
                },
                error: function(e) {
...
function() {
    var e, t = GreenLine.Qa = {
        showAskDialog: function(i) {
            return !!$GU.checkLogin() && void GL.load([GH.modules.autocomplete], function() {
                $GD.load({
                    title: i.title || "我要提问",
                    ...
                    responseCall: function() {
                        ...
                        e.length > 0) {
                            ...
                            i.showDisease) {
                                ...
                                a.change(function() {
                                    0 == a.val() ? s.show().val("").parent(".g-iptph-wrap").show() : (s.hide().val(a.find("option:selected").text()).parent(".g-iptph-wrap").hide(),
                                    e.data("validator").reset())
                                })
                            } else
                                $("#diseaseOption").remove();
                            e.validator({
                                formEvent: "null",
                                zIndex: 999999
                            })
                        ...
                        if ($GUB.isActive(n)) {
                            ...
                            $.ajax({
                                ...
                                success: function(e) {
                                    ...
                                    $GD.find(".body").html('<div class="request-result"><span class="gi1 gi-bigger-succ"></span><div class="title-text">您的问题已提交！</div><div class="content-text">您可以在<a href="/my/topic/sponsor" target="_blank">个人中心-我的提问</a>里面找到此问题，并查看最新的回复。</div></div>'),
                                    i.extCall && i.extCall())
                                },
                                error: function() {
                                    $GUB.enable(n, "确定"),
...
function(e) {
    e.fn.glTabs = function(t) {
        ...
        this.each(function() {
            var t = e(this)
              , n = t.find(i.tabs);
            n.find(i.tabChild).on(i.event, function() {
                if (e(this).hasClass(i.onCls))
                    return !1;
        ...
        this.each(function() {
            e(this).keydown(function(t) {
                var i = [8, 9, 13, 35, 36, 37, 39]
                  , n = i.join(",").match(new RegExp(t.which));
                !t.which || 49 <= t.which && t.which <= 57 || 97 <= t.which && t.which <= 105 || 48 == t.which && e(this).attr("value") || 96 == t.which && e(this).attr("value") || n || t.preventDefault()
            })
        })
    }
    ,
    e.fn.glTooltip = function(t) {
        e(this).on("mouseenter", function() {
            ...
            if ("" != e.trim(i)) {
                ...
                n.html(e(this).data("validtips") + "<i class='" + t[arrow] + "'></i>"),
                t) {
                    var o, a;
    ...
    e.fn.inputTips = function(t) {
        return this.each(function() {
            ...
            e(this).bind("focusin.inputtips", function() {
                var i = e.trim(e(this).val());
                "" != i && i != t || e(this).removeClass("tipIt").val("")
            }),
            e(this).bind("focusout.inputtips", function() {
                var i = e.trim(e(this).val());
    ...
    e.fn.glRating = function() {
        ...
        return this.each(function() {
            ...
            o.mouseenter(function() {
                ...
                var n = o.eq(t)
                  , a = s[t];
                if (void 0 == i.data("rating-type-show") || i.data("rating-type-show"))
                    var r = !0;
                else
                    var r = !1;
                ...
                i.find("#rating-tips").html(a + "<strong></strong>").css({
    ...
    e.fn.limitedText = function(t) {
        function i(e) {
            var i = e.val();
            if (i.length > n)
                e.val(i.substring(0, n));
            else {
                var a = e.parents(".js-textarea-container");
                0 == a.length && (a = e.parent()),
                null != o ? (a.find("span.minWord").html("最少<span class='num1'>" + (t.min || 20) + "</span>个字，"),
                a.find(".comment-limit label").text("需要"),
                a.find(".num").text(o - i.length),
                i.length > o && (a.find("span.minWord").html(""),
                a.find(".comment-limit label").text("可以"),
                a.find(".num").text(n - i.length))) : a.find(".num").text(n - i.length)
            }
        }
        var n = t.max
          , o = t.min;
        return this.each(function() {
            e(this).data("tips") != e(this).val() && (null != o ? (e(this).parent().find(".num").text(t.min - e(this).val().length),
            e(this).val().length > o && e(this).parent().find(".num").text(n - e(this).val().length)) : e(this).parent().find(".num").text(t.max - e(this).val().length)),
...
function(e) {
    ...
    e.extend(t.prototype, {
        _run: function() {
            ...
            n.on("click", ".pagers a", function() {
                e(this).hasClass("on") || (t.clearAutoInterval(),
                t.go(e(this).parent().find("a").index(e(this))))
            }),
            i.each(function(i) {
                e(this).css({
                    display: "block",
        ...
        _updatePager: function() {
            ...
            if (0 == o.length) {
                ...
                for (var a = 0; a < i.length; a++)
                    o.append(e("<a href='javascript:;' hidefocus='hidefocus'></a>"));
                o.appendTo(n).css("margin-left", -o.width() / 2 + "px").find("a:eq(0)").addClass("on")
            } else
                o.find("a").removeClass("on"),
        ...
        go: function(e) {
            var t = this
              , i = t.sliders;
            return !t.isAnimating && (t.isAnimating = !0,
            t.prevIndex = t.currentIndex,
            null == e ? (t.currentIndex++,
            t.currentIndex == i.length && (t.currentIndex = 0)) : t.currentIndex = e,
            void t._animate())
        }
    }),
...
function(e, t, i) {
    ...
    e.cookie = function(a, s, r) {
        if (s !== i && !/Object/.test(Object.prototype.toString.call(s))) {
            if (r = e.extend({}, e.cookie.defaults, r),
            null === s && (r.expires = -1),
        ...
        for (var d, p = r.raw ? n : o, u = t.cookie.split("; "), h = 0; d = u[h] && u[h].split("="); h++)
            if (p(d.shift()) === a)
                return p(d.join("="));
        return null
    }
    ...
    e.removeCookie = function(t, i) {
        return null !== e.cookie(t, i) && (e.cookie(t, null, i),
        !0)
    }
}(jQuery, document),
function(e) {
    e.fn.initSche = function() {
        function t(t, i, n) {
            ...
            n && (t.find(".prev,.next").show(),
            0 == i ? t.find(".prev").hide() : i == n - 1 ? t.find(".next").hide() : t.find(".prev,.next").show());
        ...
        return this.each(function() {
            ...
            t(o, a.getCurrentSlide(), a.getSlideCount()),
            o.find(".prev").on("click", function() {
                a.goToPrevSlide()
            }),
            o.find(".next").on("click", function() {
                a.goToNextSlide()
            })) : t(o, 0),
            $GC.isLogined ? n.find(".order-it").click(function() {
                if (console.log(location.pathname.indexOf("department") > -1),
                location.pathname.indexOf("department") > -1) {
                    var t = e(this).data("isidentify")
                      , i = e(this).attr("href");
                    "0" == t ? GreenLine.Modal2.confirmTreatModal.load(e(this)) : "1" != t && "2" != t || $GM.confirm.load(e(this), {
                        title: "实名认证",
                        icon: '<div class="pop-icon-alert"></div>',
                        okTxt: "立即认证",
                        cancelTxt: "放弃预约",
                        message: '您的账号还未实名认证<p class="sub-text">应国家卫计委要求，预约挂号必须进行实名认证，请完善相关信息后再进行操作。</p>',
                        call: function() {
                            e.cookie("cert_backUrl", i, {
                                expires: 1,
                                path: "/"
                            }),
                            location.href = "/user/user_cert?source=book&skip=" + t
                        }
                    })
                } else
                    GreenLine.Modal2.confirmTreatModal.load(e(this));
                return !1
...
function(e) {
    function t(t) {
        var i = this;
        t.data("phtext") ? i.doInit(t) : e.each(t.find("[data-phtext]"), function(t, n) {
            i.doInit(e(n))
        })
    }
    e.extend(t.prototype, {
        ...
        doUpdate: function(e, t) {
            e.data("phtext") && "" != t && (e.data("phtext", t),
            this.doInit(e))
        }
    }),
    e.extend(t, {
        ...
        doPlaceholder: function(e, t) {
            e.parent().hasClass("g-placeholder-wrap") || (e.wrap("<span class='g-placeholder-wrap'/>"),
            e.after("<em/>"));
...
function(e) {
    ...
    e.fn.glNewPlaceholder = function(n) {
        this.data("phtext") ? (null != n && this.data("phtext", n),
        t(this, this.data("phtext"))) : this.data("initText") ? null != n && i(this, n) : e.each(this.find("[data-phtext]"), function(i, o) {
